...
# Certificate views removed - sertifikati su sada deo CompanyStandard modela
...
urlpatterns = [
    ...
    path('srbija-tim/auditor-schedule/', SrbijaTimAuditorScheduleView.as_view(), name='srbija_tim_auditor_schedule'),
