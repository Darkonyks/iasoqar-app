...
class Appointment(models.Model):
    ...
    APPOINTMENT_STATUS_CHOICES = [
        (STATUS_SCHEDULED, _('Zakazano')),
        (STATUS_COMPLETED, _('Završeno')),
        (STATUS_CANCELLED, _('Otkazano')),
        (STATUS_POSTPONED, _('Odloženo')),
    ]
    
    APPOINTMENT_TYPE_CHOICES = [
        ('audit', _('Audit')),
        ('meeting', _('Sastanak')),
        ('consultation', _('Konsultacija')),
        ('training', _('Trening')),
        ('other', _('Ostalo')),
    ]
    ...
    end_datetime = models.DateTimeField(_("Vreme završetka"))
    all_day = models.BooleanField(_("Celodnevni događaj"), default=False)
